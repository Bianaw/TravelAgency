...
namespace TravelAgencyService.Controllers
{
    ...
    public class BookingsController : Controller
    {
        ...
        public async Task<IActionResult> Create(int packageId, int qty = 1)
        {
            ...
            if (activeCount + 1 > rule.MaxActiveBookings)
            {
...

        {
            ...
            booking.PaidAmount = booking.PriceAtBooking * booking.RoomsCount;
    ...
    .FirstOrDefaultAsync())?.Trim();
        ...
        public async Task<IActionResult> Cancel(int id)
        {
            ...
            {
                if (booking.TravelPackage != null)
                    booking.TravelPackage.AvailableRooms += booking.RoomsCount;
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            //  מאפשרים למחוק רק אם בוטל
            if (booking.Status != BookingStatus.Cancelled)
            {
                TempData["Msg"] = "You can delete only cancelled bookings.";
                return RedirectToAction(nameof(MyBookings));
            }
            ...
            TempData["Msg"] = "Cancelled booking deleted.";
            return RedirectToAction(nameof(MyBookings));
        }
